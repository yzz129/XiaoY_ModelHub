...
export const catalogModels: CatalogModel[] = [
  ...
  { id: 'groq-gpt-oss', apiModel: 'openai/gpt-oss-120b', name: 'GPT-OSS 120B', provider: 'Groq', providerId: 'groq', category: 'chat', pricing: 'free-quota', quota: '免费账户受 RPM、RPD、TPM 与 TPD 限制', quotaLookup: 'Groq Limits 页面查看精确剩余限制', integration: 'catalog', description: '低延迟大语言模型推理', docsUrl: 'https://console.groq.com/docs/models', keyUrl: 'https://console.groq.com/keys' },
  { id: 'openrouter-free', apiModel: 'openrouter/free', name: 'Free Models Router', provider: 'OpenRouter', providerId: 'openrouter', category: 'chat', pricing: 'free', quota: '自动路由到免费模型，限流较低，不适合生产', quotaLookup: '可通过 Credits API 查询账户余额', integration: 'catalog', description: '自动选择当前可用免费模型', docsUrl: 'https://openrouter.ai/docs', keyUrl: 'https://openrouter.ai/settings/keys' },
  ...
  { id: 'pollinations-flux', apiModel: 'flux', name: 'FLUX', provider: 'Pollinations', providerId: 'pollinations', category: 'image', pricing: 'free-quota', quota: '免费入口和模型策略可能调整，按官方账户策略为准', quotaLookup: 'Pollinations 账户页查看', integration: 'catalog', description: '统一 API 图片生成入口', docsUrl: 'https://enter.pollinations.ai/api/docs', keyUrl: 'https://enter.pollinations.ai/' },
  ...
  { id: 'groq-whisper', apiModel: 'whisper-large-v3-turbo', name: 'Whisper Large V3 Turbo', provider: 'Groq', providerId: 'groq', category: 'audio', pricing: 'free-quota', quota: '免费账户受音频时长和每日请求限制', quotaLookup: 'Groq Limits 页面查看', integration: 'catalog', description: '高速语音转文字', docsUrl: 'https://console.groq.com/docs/speech-to-text', keyUrl: 'https://console.groq.com/keys' },
  { id: 'eleven-flash', apiModel: 'eleven_flash_v2_5', name: 'Eleven Flash v2.5', provider: 'ElevenLabs', providerId: 'elevenlabs', category: 'audio', pricing: 'free-quota', quota: '新账户含约 10,000 免费 credits，生成会扣减 credits', quotaLookup: 'Developers Analytics 可查看精确用量', integration: 'catalog', description: '低延迟文字转语音', docsUrl: 'https://elevenlabs.io/docs/api-reference/introduction', keyUrl: 'https://elevenlabs.io/app/settings/api-keys' },
