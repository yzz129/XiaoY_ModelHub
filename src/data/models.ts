...
export const imageModels: GenerationModelOption<ImageModel>[] = [
  { id: 'doubao-seedream-5-0-pro-260628', name: 'Seedream 5.0 Pro', description: '旗舰单图与精准创作', resolutions: ['1K', '2K'], maxPromptLength: 32000 },
  { id: 'doubao-seedream-5-0-260128', name: 'Seedream 5.0 Lite', description: '高性价比通用生图', resolutions: ['2K', '3K'], maxPromptLength: 600 },
  { id: 'doubao-seedream-4-5-251128', name: 'Seedream 4.5', description: '高质量与文字表现', resolutions: ['2K', '4K'], maxPromptLength: 600 },
  { id: 'doubao-seedream-4-0-250828', name: 'Seedream 4.0', description: '稳定通用创作', resolutions: ['1K', '2K', '4K'], maxPromptLength: 600 },
]

export const videoModels: GenerationModelOption<VideoModel>[] = [
  { id: 'doubao-seedance-2-0-260128', name: 'Seedance 2.0', description: '旗舰画质与多模态参考', resolutions: ['720p', '1080p'], maxPromptLength: 20000 },
  { id: 'doubao-seedance-2-0-fast-260128', name: 'Seedance 2.0 Fast', description: '快速生成与动态表现', resolutions: ['720p'], maxPromptLength: 20000 },
  { id: 'doubao-seedance-2-0-mini-260615', name: 'Seedance 2.0 Mini', description: '轻量高性价比', resolutions: ['720p'], maxPromptLength: 20000 },
]
