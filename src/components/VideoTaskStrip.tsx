...
const statusLabels: Record<VideoJob['status'], string> = {
  queued: '等待空闲槽位', submitting: '正在提交服务商', running: '正在生成', paused: '本地查询已暂停', failed: '任务需要处理',
}
