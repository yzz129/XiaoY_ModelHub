...
import { getGenerationModel, getThreeDModel } from '../data/models'
...
function LazyModelPreview(props: ComponentProps<typeof ModelPreview>) {
  return <Suspense fallback={<ThreeDPreview compact={props.compact} />}><ModelPreview {...props} /></Suspense>
}
